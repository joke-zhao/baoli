var app = new Vue({
	...
	data:{
		...
		RightTitle:"数据管理",
		num: 0,
		RightContent:"方案概述：<p>数据管理解决方案聚焦政企客户的业务核心数据管理，为政企客户提供全方位的大数据管理解决方案，构建数据资产，实现数据价值变现且持续增值，保障数据安全管控。该解决方案已广泛应用在公用事业、政府、医院、公安、社保、海关等多行业。 </p>"
	},
	methods:{
		move:function(){
...
$(document).ready(function(){
	...
	$(".contents .left").hover(function(){
		...
		$(".contents .left dl dd").eq(5).css({"border-right":"#db2e18 1px solid","background-color":"#fbeae7"});
	});
});